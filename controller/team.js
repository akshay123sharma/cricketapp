  ...
  matchDetail: async(req,res)=> {
         try{
            ...
            if(matchDetailArr){
                ...
                matchDetailArr.team1_name = team_one.name;
                matchDetailArr.team2_name = team_two.name;
                matchDetailArr.team1_photo = team_one.team_photo;
                matchDetailArr.team2_photo = team_two.team_photo;
